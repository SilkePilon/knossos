    ...
    nags() {
      return [
        ...
        },
        {
          ...
          id: 'add-links',
          description:
            'Add any relevant links targeted outside of Beehive, such as sources, issues, or a Discord invite.',
          status: 'suggestion',
          link: {
            path: 'settings/links',
        ...
        },
        {
          ...
          description: `Your project has been ${this.project.status} by
            Beehive's staff. In most cases, you can resubmit for review after
