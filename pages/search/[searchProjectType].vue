<template>
  ...
  >
    <Head>
      <Title>Search {{ projectType.display }}s - Beehive</Title>
    </Head>
    <aside
      :class="{
...
const description = computed(
  () =>
    `Search and browse thousands of Minecraft ${projectType.value.display}s on Beehive with instant, accurate search results. Our filters help you quickly find the best Minecraft ${projectType.value.display}s.`
)
