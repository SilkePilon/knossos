      ...
      <div class="users-section">
        ...
        <div class="feature-blob">
          <div class="blob-text">
            ...
            <p>
              Beehive's lightning-fast search and powerful filters let you find what you want as
              you type.
            </p>
          </div>
        ...
        <div class="feature-blob">
          <div class="blob-text">
            ...
            <p>
              Beehive's open-source API lets launchers add deep integration with Beehive. You can
              use Beehive through
    ...
    <div class="creator-section">
      ...
      <div class="features">
        ...
        <div class="feature gradient-border">
          ...
          <p>
            Get the best modding experience possible with constant updates from the Beehive team
          </p>
        </div>
      </div>
    </div>
