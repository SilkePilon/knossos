<template>
  <div class="markdown-body">
    ...
    <h2>Introduction</h2>
    <p>
      <a href="https://modrinth.com">Beehive</a> is part of Rinth, Inc. ("Company", "us", "we",
    ...
    <p>
      ...
      when you use www.modrinth.com, api.modrinth.com, or the Beehive App ("Service" or "Website"),
    ...
    <p>Rinth, Inc. is the data controller for data collected through Beehive.</p>
    ...
    <p>When you view a project page or download a file from Beehive, we collect:</p>
    <ul>
    ...
    <h3>Playtime data</h3>
    <p>When you use the Beehive App to play Beehive projects, we collect:</p>
    <ul>
      <li>Your IP address</li>
      <li>Your user ID</li>
    ...
    <h3>Usage data</h3>
    <p>When you interact with the Beehive App or the Website, we collect through MixPanel:</p>
    <ul>
      <li>Your IP address</li>
    ...
    <p>
      We use some third-party services to make Beehive run. Please refer to each of their privacy
    ...
    <p>
      Beehive does not knowingly collect any Personal Identifiable Information from children under
    ...
    <p>
      ...
      website with regards to the information that they shared and/or collect in Beehive. This
...
<script setup>
const description =
  'The Privacy Policy of Beehive, an open source modding platform focused on Minecraft.'

useSeoMeta({
  title: 'Privacy Policy - Beehive',
  description,
