<template>
  <div class="markdown-body">
    ...
    <p>
      ...
      api.modrinth.com, or the Beehive App, including any content, functionality and services
      offered on or through www.modrinth.com, api.modrinth.com, or the Beehive App (the "Service"),
    ...
    <p>
      ...
      (Beehive API). The Beehive API enables users to perform actions on the Service via their own
      services, such as their websites and/or applications.
    </p>
    <p>
      We grant the User of the Beehive API a limited, non-exclusive, non-sublicensable and
    ...
    <ul>
      <li>
        The User uses the Beehive API in accordance with these Terms, the Community Standards and
        all applicable laws and regulations that apply to such use.
      </li>
      <li>the User does not infringe any rights of third parties.</li>
      <li>
        the User provides Beehive all assistance requested in complying with, and concluding all
        agreements required by the applicable laws and regulations.
      </li>
    </ul>
    <p>
      Each User using the Beehive API shall indemnify Beehive and keep Beehive indemnified for
    ...
    <h2>Trademarks</h2>
    <p>
      The Company name, the terms Beehive, the Company logo and all related names, logos, product
...
<script setup>
const description =
  'The Terms of Use of Beehive, an open source modding platform focused on Minecraft.'

useSeoMeta({
  title: 'Terms of Use - Beehive',
  description,
