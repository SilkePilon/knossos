<template>
  <div class="markdown-body">
    ...
    <p>
      This is the security notice for all Beehive repositories. The notice explains how
...
<script setup>
const description =
  'The Security Notice of Beehive, an open source modding platform focused on Minecraft.'

useSeoMeta({
  title: 'Security Notice - Beehive',
  description,
