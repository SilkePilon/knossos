<template>
  <div>
    ...
    <section class="universal-card">
      ...
      <p>
        By uploading projects to Beehive and withdrawing money from your account, you agree to the
      ...
      <p>
        Beehive will deduct <strong>2%</strong> for the fee (minimum of $0.25 and maximum of $20)
        from <strong>all transfers</strong> and if the fee PayPal charges is less than the amount we
        deducted, the difference will be added back to your Beehive balance. This happens as
        Beehive cannot determine if a transaction will be in the United States or international or
      ...
      <p>
        All revenue generated by Beehive is in United States dollars. Any conversions to your local
        currency will happen at withdrawal and is not handled by Beehive. Beehive cannot guarantee
