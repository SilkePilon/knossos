  ...
  <div>
    <div class="landing-hero">
      <h1 class="main-header">
        Download The Beehive <br v-if="os" />
        App
        {{ os ? `for ${os}` : '' }}
      </h1>
      <h2 class="main-subheader">
        Project Beehive is an open source Minecraft bot with a goal to provide players access to helpful gameplay features at no cost. All in one neat little package.
      </h2>
