<template>
  <div>
    <ModalConfirm
      ...
      description="This will **immediately delete all of your user data and follows**. This will not delete your projects. Deleting your account cannot be reversed.<br><br>If you need help with your account, get support on the [Beehive Discord](https://discord.modrinth.com)."
          ...
          <template v-if="twoFactorStep === 0">
            ...
            <qrcode-vue
              ...
              :value="`otpauth://totp/${encodeURIComponent(
                auth.user.email
              )}?secret=${twoFactorSecret}&issuer=Beehive`"
              :size="250"
              :margin="2"
              level="H"
            />
...
useHead({
  title: 'Account settings - Beehive',
})
